...
import 'package:booktticket/widgets/thick_container.dart';
...
class TicketView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final sizee = AppLayout.getSize(context);
    return SizedBox(
      width: sizee.width * 0.90,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            //This Container for showing Blue part of Card Ticket
            Container(
              ...
              child: Column(
                children: [
                  Row(
                    children: [
                      Text(ticket['from']['code'],style:
                      isColor == null ? Styles.headLineStyle3.copyWith(color: Colors.white):
                      ...
                      Expanded(child: Stack(
                        ...
                        children: [SizedBox(
                          ...
                          Center(
                            child: Transform.rotate(angle: 1.5,child: Icon(Icons.local_airport_rounded,color: isColor == null ? Colors.white : Color(0xFF81CCF7),)
                            ),
                          ),
                        ]
                      )
                    ...
                    children: [
                      SizedBox(
                        width: AppLayout.getWidth(100),
                          child: Text(
                            ticket['from']['name'],style: isColor == null ?  Styles.headLineStyle4.copyWith(color: Colors.white): Styles.headLineStyle4,)
                      ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      AppColumnLayout(firstText: ticket['number'].toString(),
                        secondText: "Number", alignment: CrossAxisAlignment.center, isColor: isColor,),
